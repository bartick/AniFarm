        ...
        async execute(interaction) {
            ...
            const embeds = [
                ...
                new MessageEmbed()
                    ...
                    .addField('SR Evo 1 ', `**Hp:** ${parseInt(card.HP*sr[0])}\n**Atk:** ${parseInt(card.ATK*sr[0])}\n**Def:** ${parseInt(card.DEF*sr[0])}\n**Speed:** ${parseInt(card.SPEED*sr[0])}`, true)
                ...
                .setTitle(`**${card.NAME}**`)
                .setFooter(`${card.FOOTER} | ID: ${card.ID}`)
                .addField('UR Evo 1 ', `**Hp:** ${parseInt(card.HP*ur[0])}\n**Atk:** ${parseInt(card.ATK*ur[0])}\n**Def:** ${parseInt(card.DEF*ur[0])}\n**Speed:** ${parseInt(card.SPEED*ur[0])}`, true)
